...
SEED = 20260915
ROOT = Path(".")
OUT = ROOT / "results/trc_v4/sota_models"
...
def run_city(spec: CitySpec):
    ...
    return predictions, pd.DataFrame(metrics), gate, protocol
...
def main() -> None:
    ...
    specs = [
        CitySpec(
            city="Toronto",
            predictions=ROOT / "results/trc_v3/toronto_time_safe_benchmark/predictions.parquet",
            context=ROOT / "results/trc_v3/reviewer_experiments/toronto_events_exposure_time_safe.parquet",
            experts=(
        ...
        CitySpec(
            city="New York",
            predictions=ROOT / "results/trc_v4/nyc_strong_benchmark/predictions.parquet",
            context=ROOT / "results/trc_v4/nyc_dynamic_scope/snapshots.parquet",
            experts=(
    ...
    for spec in specs:
        ...
        predictions, metrics, gates, protocol = run_city(spec)
